...
static Keychord *keychords[] = {
	...
	// moc
	&((Keychord){1, {{MODKEY, XK_equal}},       			   spawn,         {.v = mocseekp } }),
	&((Keychord){1, {{MODKEY, XK_minus}},       			   spawn,         {.v = mocseekl } }),
	&((Keychord){1, {{MODKEY, XK_space}},       			   spawn,         {.v = mocppause } }),
	&((Keychord){1, {{MODKEY, XK_comma}},       			   spawn,         {.v = mocprevious } }),
	&((Keychord){1, {{MODKEY, XK_period}},       			   spawn,         {.v = mocnext } }),
	// // apps
	&((Keychord){1, {{MODKEY, XK_e}},       			   spawn,         {.v = mocnext } }),
